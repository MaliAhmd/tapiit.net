                ...
                <div class="form-container">
                    <div class="form-wrapper">
                        <form action="/addcred" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="user-form">
                                <h4 class=" mb-0 pb-1 pt-3 text-center" style="letter-spacing: 1px;  font-family: Futura normal; text-transform: uppercase; ">
                                    USER INFORMATION</h4>
                                <div class="fields">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="input-field-container">
                                        <div class="input-field-wrapper">
                                            <input type="text" placeholder="Company Description/Info" class="input-field" name="description" maxlength="120"/>
                                            <!-- <i class="fas fa-times"></i> -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="input-field-container">
                                        <div class="input-field-wrapper">
                                            <input type="text" name="cc" placeholder="Country" class="input-field" />
                                ...
                                <div class="pt-1 mb-2 text-center">
                                    ...
                                    <a class=" btn btn-warning my-3"  style="bacground: #fc107; margin-left:10px !important; width:100px; margin:0 auto; " href="{{route('onetimelayout')}}">SKIP </a>
